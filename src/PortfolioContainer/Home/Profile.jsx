        ...
        <>
            <div className="row " >
                <div className="profile-container col-md-12" id="home">
                    <div className="row  "  >
                        <div className="col-md-12" style={{margin:"0px" ,padding :"0px",position:"fixed",top:"0px"}} >
                            
                            <Navbar  expand="lg" className="myNav" >
                                <Container fluid>
                                    <Navbar.Brand href="#home"><p style={{color:"#ffffff"}}>Akash Bhoi</p></Navbar.Brand>
                            ...
                            <div className="profile-details">
                                <div className="colz">
                                    <div className="colz-icon">
                                        ...
                                        <a target="_blank" rel="noopener noreferrer" href="https://github.com/akashbhoi2815"><FaGithubSquare className='social-media-icon' /></a>
                                    </div>
                                </div>
                                ...
                                <div className="profile-details-name">
                                    ...
                                    {" "}
                                    Hello, I'm <span className="highlighted-text">Akash Bhoi</span>
                                </div>
                                <div className="profile-details-role">
                                    <span className='primary'>
                                        ...
                                        It's Nice To Meet You. I Design And Code from scratch, And I Love What I Do.
                                        </span>
                                    </span>
                                </div>
